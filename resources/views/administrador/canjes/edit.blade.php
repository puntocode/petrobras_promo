		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">Editar Canje</h3>
					<div class="row">
						<div class="col-md-8">
							<div class="panel">
								<div class="panel-body">
                                    <form action="/editar/canje" method="POST">
                                        @csrf
                                        <input type="hidden" name="cupon_id" value="{{$factura->id}}">
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input name="monto_factura" type="text" class="form-control" value="{{number_format($factura->total, 0, '', '.')}}">
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select name="estado" class="form-control">
                                                    ...
                                                    @else 
                                                        ...
                                                        <option selected value="cheat">Descalificar</option> 
                                                    @endif    
                                                </select>
                                            </div>
                                            <div class="col-md-12" style="margin-top:20px">
                                                <button class="btn btn-success" type="submit">Guardar</button>
                                                <a href="/canjes" class="btn btn-warning" type="button">Cancelar</a>
                                                <button type="button" class="btn btn-primary pull-right" onclick="rotate()" id="button">Girar Imagen</button>
                                            </div>
                                        </div>
                                    </form>
								</div>
